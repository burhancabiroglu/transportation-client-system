...
class _TransferApi implements TransferApi {
  ...
  @override
  Future<BaseResponse<List<SeatReservation>>> getSeatReservations() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseResponse<List<SeatReservation>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = BaseResponse<List<SeatReservation>>.fromJson(
      _result.data!,
      (json) => json is List<dynamic>
          ? json
              .map<SeatReservation>(
                  (i) => SeatReservation.fromJson(i as Map<String, dynamic>))
              .toList()
          : List.empty(),
    );
    return value;
  ...
  @override
  Future<BaseResponse<String>> reserveSeat(String seatId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'seatId': seatId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseResponse<String>>(Options(
