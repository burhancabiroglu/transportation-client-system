...
Future setup() async {
  ...
  injector.registerSingleton(CacheHandler(storage: injector<LocalStorage>()));
  ...
  injector.registerSingleton<ConfigRepo>(ConfigRepoImpl(api: injector<AppConfigApi>(), cacheManager: injector<CacheHandler>()));
}