  ...
  static FormFieldValidator<T> required<T>({
    ...
    return (T? valueCandidate) {
      if (valueCandidate == null ||
        ...
        return errorText ?? "error: required";
      }
      return null;
    };
  }
